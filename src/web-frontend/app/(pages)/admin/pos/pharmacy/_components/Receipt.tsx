...
export default function Receipt({ transaction, onClose }: Props) {
  // Calculate the breakdown for receipt
              ...
              {transaction.cash && (
                <>
                  <div className="flex justify-between text-sm mt-2">
                    <span>Cash:</span>
                    <span>₱{parseFloat(transaction.cash).toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Change:</span>
                    <span>
                      ₱{parseFloat(transaction.change || 0).toFixed(2)}
                    </span>
                  </div>
                </>
              )}
